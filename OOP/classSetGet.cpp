...
private:
    ...
    double weight;
public:
    void setValues(string el, char top, string charge, double weight) {
        this->el = el;
        this->top = top; 
        this->charge = charge; 
        this->weight = weight;
...
int main() {
    ...
    Element obj_1, obj_2, obj_3;
    obj_1.setValues("Нейтрон",  'Н', " 0", 940);
    obj_2.setValues("Ка-плюс",  'M', "+1", 494);
    obj_3.setValues("Электрон", 'Л', "-1", 0.511);
